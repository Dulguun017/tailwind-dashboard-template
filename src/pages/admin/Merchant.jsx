                    ...
                    merchants.map((merchant) => (
                      <>
                        <tr className="bg-white border-b dark:bg-gray-800 dark:border-gray-700 hover:bg-gray-50 dark:hover:bg-gray-600">
                          ...
                          <td class="px-6 py-4">{merchant.mcc}</td>
                          <td class="px-6 py-4">
                            {merchant.active ? "ACTIVE" : "INACTIVE"}
                          </td>
                          <td class="px-6 py-4">{merchant.type}</td>
                          <td class="px-6 py-4">
                            <button
                            ...
                            {showModal ? (
                              <MerchantModal
                                ...
                                merchant={isUpdate ? merchant : null}
                                isUpdate={isUpdate}
                        ...
                        {/* <tr class="bg-white border-b dark:bg-gray-800 dark:border-gray-700 hover:bg-gray-50 dark:hover:bg-gray-600">
                          <td class="w-4 p-4">
                            <button className="bg-blue-200  border-0 active:bg-blue-500  font-medium text-blue-600 dark:text-blue-500 hover:underline">
                              Edit
                            </button>
                          </td>
                        </tr> */}
